...
|[ // Rows 1-11: Large hollow space (Washing machine slot) [[2, 11, 0], 9], 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, // Row 12: Middle horizontal divider (Spans 2 columns, 1 row high) [[2, 1], 9], // Rows 13-18: Bottom vertical doors (Each door is 1 column wide, 4 rows high) [[1, 4], [1, 4]], 9, 9, 9 ]|![](./assets/tutorial2/22.png)|![](./assets/tutorial2/23.png)|
|[ [[5,1],9,9,9,9], [[1,9],[1,9],[2,1],9,[1,9]], [9,9,[2,6,0],9,9], 9,9,9,9,9, [9,9,[1,2],[1,2],9], 9 ];|![](./assets/tutorial2/24.png)|![](./assets/tutorial2/25.png)|