...
(The method used in this project is completely free. If you find the workflow a bit too involved, you might want to try the freemium app I developed later: [FloorPlan23D.xyz](https://floorplan23d.xyz/)
